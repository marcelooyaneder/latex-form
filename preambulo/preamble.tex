...
\setlength{\parindent}{0cm} %se hace la sangría nula
...
\usepackage{sfmath} %formulas matematicas, de acuerdo a la fuente elegida.
...
%modificación a la forma de hacer referencias en el documento.
\usepackage{prettyref} %paquetes para hacer referencia de mejor manera
\newrefformat{tab}{tabla \ref{#1}}
